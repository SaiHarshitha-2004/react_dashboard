...
const Ecommerce = () => {
  ...
  return (
    <div className='mt-12'>
      ...
      <div className="relative w-full h-[400px] overflow-hidden ml-5 mr-5 rounded-2xl ">
            <p className="absolute top-0 left-0 w-full h-full bg-cover bg-hero-pattern bg-center bg-no-repeat p-8" >
               <p className='font-bold  text-gray-800'>Earnings</p>
                <p className='text-2xl pt-4 pb-4'>Rs 1240,6432.21</p>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>Rs 93,546</span>
                  <span className='p-1 hover:drop-shadow-xl cursor-pointer rounded-full text-white
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>Rs 56,546</span>
                </p>
